<template>
  <div class="text-h5 text-sm-h4 text-md-h4 text-lg-h4 mb-3 pl-1 font-weight-medium">Integrador</div>


  <v-row>
    <v-col cols="12">
      <v-card class="pa-5">
        <v-card-title class="border-bottom d-block">
          Preencha os dados do Integrador
        </v-card-title>
        <v-card-text>
          <v-row>
            <v-col cols="12" md="6">
          ...
          <v-row>
            <v-col>
              ...
              <v-btn flat  class="mx-2" @click="dialog = true">Add Project</v-btn>
            </v-col>
          </v-row>
    ...
    <v-card>
      ...
      <v-card-text>
        <v-form class="px-3">
          ...
          <v-btn flat  class="success mx-0 mt-3" @click="dialog = false">Add Project</v-btn>
        </v-form>
      </v-card-text>
    </v-card>
  </v-dialog>
